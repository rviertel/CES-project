...
void uq_ET(InputData* input_data, FILE* fp) {
  ...
  for (i = 0; i <= (4*TIME); i++)
    {
      ...
      fprintf (fp,"%.17e %.17e %.17e %.17e %.17e %.17e %.17e %.17e %.17e %.17e %.17e %.17e %.17e %.17e\n", (*input_data).amplitude,(*input_data).frequency,(*input_data).duty_cycle, t, V, nK, hNaP, mH, mCaT, hCaT, wBK, Ca, nMystery, tau);
